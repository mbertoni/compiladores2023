...
{-
sTerm2Doc at (S.Var x) = name2doc x
sTerm2Doc at (S.UOp _ x) = abort "unimplemented"
sTerm2Doc at (S.Let _ _ _ x) = abort "unimplemented"
sTerm2Doc at (S.IfZ x) = abort "unimplemented"
sTerm2Doc at (S.Lit c) = integer2doc c
sTerm2Doc at (S.Lam [] t) = abort "unimplemented"
sTerm2Doc at (S.Lam [(v, ty)] t) =
  parenIf at $
    sep
      [ sep
...
sTerm2Doc at (S.Fix (f, fty) [(x, xty)] m) =
  parenIf at $
    sep
      [ sep
